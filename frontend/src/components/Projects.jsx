const projects = [
  {
    ...
    frontendGithub:
      "https://github.com/Vedhasree-dotcom/CRAFTAPP_FRONT",
    backendGithub:
      "https://github.com/Vedhasree-dotcom/CRAFTAPP_BACK",
...

  {
    ...
    github:
      "https://github.com/Vedhasree-dotcom/Grace-and-Gloss-Salon",
  ...
  return (
    <section id="projects" className="section">
      <div className="section-heading scroll-reveal">
        ...
        <h2>
          Projects that show <span>what I can do.</span>
        </h2>
      </div>
      ...
      <div className="project-list">
        {projects.map((project, index) => (
          <article
            className="project-card scroll-card"
            key={project.number}
